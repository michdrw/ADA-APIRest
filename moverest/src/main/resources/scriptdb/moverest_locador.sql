...
CREATE TABLE `locador` (
  ...
  `juricidad` varchar(45) NOT NULL,
  `inmobiliaria_id` int(11) NOT NULL,
  PRIMARY KEY (`locador_id`),
  UNIQUE KEY `locador_id_UNIQUE` (`locador_id`),
  KEY `locador_inmobiliaria_FK_idx` (`inmobiliaria_id`),
  CONSTRAINT `locador_inmobiliaria_FK` FOREIGN KEY (`inmobiliaria_id`) REFERENCES `inmobiliaria` (`inmobiliaria_id`)
...
INSERT INTO `locador` VALUES (1,'Michelle Drew','dni',66666666,24,'natural',1);
