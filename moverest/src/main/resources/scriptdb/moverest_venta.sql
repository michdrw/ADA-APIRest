...
CREATE TABLE `venta` (
  ...
  UNIQUE KEY `idvventa_identa_UNIQUE` (`venta_id`),
  KEY `venta_inmueble_FK_idx` (`inmueble_id`),
  KEY `venta_locatario_FK_idx` (`locatario_id`),
  CONSTRAINT `venta_inmueble_FK` FOREIGN KEY (`inmueble_id`) REFERENCES `inmueble` (`inmueble_id`),
  CONSTRAINT `venta_locatario_FK` FOREIGN KEY (`locatario_id`) REFERENCES `locatario` (`locatario_id`)
...
INSERT INTO `venta` VALUES (1,130000,2,2);
